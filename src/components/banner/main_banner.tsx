...
const SwiperElement = () => {
    return(
        <div className='main_banner_container'>
           ...
           <div className="main_banner_inner_details">
            <div className="mb_titles">
                    <div className="mb_teams_box">
                        <div className="mb_team_box"><Image src={manu} alt='team' className='mb_team_box_image' /></div>
                        <div className="mb_team_versus">V</div>
                        <div className="mb_team_box"><Image src={chele} alt='team' className='mb_team_box_image' /></div>
                    </div>
